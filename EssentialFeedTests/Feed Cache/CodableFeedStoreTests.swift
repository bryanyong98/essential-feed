...
//  EssentialFeedTests
//
//  Created by Bryan Yong on 12/10/2025.
//

import XCTest
import EssentialFeed

typealias FailableFeedStore = FailableRetreieveFeedStoreSpecs & FailableInsertFeedStoreSpecs & FailableDeleteFeedStoreSpecs
...
class CodableFeedStoreTests: XCTestCase, FailableFeedStore {
    ...
    func test_retrieveAfterInsertingToEmptyCache_deliversInsertedValue() {
        ...
        sut.insert(feed, timestamp: timestamp) { insertionError in
            XCTAssertNil(insertionError, "Expected feed to be inserted, hence no errs")
